...
class GalagaCartridge : GameCartridge {
    ...
    private data class Bullet(var x: Int, var y: Int, val isPlayerBullet: Boolean)
    private data class Enemy(var x: Int, var y: Int, var type: Char = '*')
    ...
    private suspend fun showGameOver(arcade: ArcadeSystem) {
        arcade.clearScreen()
